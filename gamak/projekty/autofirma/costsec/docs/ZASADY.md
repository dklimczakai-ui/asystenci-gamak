...
- **R15 — `.claude/settings.local.json` + bash command history NIGDY tracked w repo** *(propozycja z R1 incident 2026-05-05, status: **do decyzji właściciela**)*
...
- **R16 — Test data dla systemów z PII = mock-from-day-0** *(propozycja z R1 incident 2026-05-05, status: **do decyzji właściciela**)*
...
- **R17 — Procedura kryzysowa GitHub: pre-flight checklist filter-repo** *(propozycja z R1 incident 2026-05-05, status: **do decyzji właściciela**)*
...
- **R18 — Audit raporty incydentów: meta-protokół (sekrety strukturalnie, nie wartościowo)** *(propozycja z meta-incident 2026-05-05, status: **do decyzji właściciela**)*
